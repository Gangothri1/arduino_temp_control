...
// Constants for pins
const int TMP36_PIN = A0; // LM35 temperature sensor pin
...
void updateLED(unsigned long interval) {
  ...
  if (currentTime - previousToggleTime >= interval) {
    previousToggleTime = currentTime; // Save the last time LED was toggled
